...
interface BackendResult {
  ...
  description?: string;
  severity?: string;
  // you can add other fields from backend if needed (filename, saved_to, etc.)
}
...
export default function InferencePage({
  ...
  // Derive a simple severity label if backend didn't send one
  const severity =
    result.severity ||
  ...
  // Normalize recommendations to an array
